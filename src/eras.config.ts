...
// Order: oldest era first — later entries win on yearMonth collision in normalize.ts.
export const ERAS: Era[] = [
  ...
  },
  {
    ...
    assets: {
      ...
      lineItems: [
        { id: "checking", label: "עו״ש", col: "B" },
        { id: "money_market", label: "קרן כספית בבנק", col: "C" },
        { id: "brokerage", label: "תיק השקעות IB", col: "D" },
        { id: "pension", label: "פנסיה", col: "E" },
        { id: "study_fund", label: "קרן השתלמות", col: "F" },
      ],
    },
    incomeExpenses: {
      tab: "הכנסות הוצאות",
      ...
      expensesTotalCol: "Y",
      cashflowTotalCol: "AC",
      // Sheet banners: צרכים I–M · מותרות N–Q · דירה R–V · מנויים W–X
      // Site override: אוכל בחוץ (J) → luxury (sheet still groups it under צרכים)
      expenseLineItems: [
        { id: "groceries_shared", label: "מצרכים", col: "I", kind: "need" },
        { id: "eating_out", label: "אוכל בחוץ", col: "J", kind: "luxury" },
        { id: "phone", label: "פלאפון", col: "K", kind: "need" },
        { id: "transit", label: "תחבורה ציבורית", col: "L", kind: "need" },
        { id: "studies", label: "לימודים", col: "M", kind: "need" },
        { id: "education", label: "השכלה", col: "N", kind: "luxury" },
        { id: "shows", label: "הופעות", col: "O", kind: "luxury" },
        { id: "projects", label: "פרוייקטים", col: "P", kind: "luxury" },
        { id: "misc", label: "שונות", col: "Q", kind: "luxury" },
        { id: "rent", label: "שכירות", col: "R", kind: "need" },
        { id: "electricity", label: "חשמל", col: "S", kind: "need" },
        { id: "water", label: "מים", col: "T", kind: "need" },
        { id: "arnona", label: "ארנונה", col: "U", kind: "need" },
        { id: "internet", label: "אינטרנט", col: "V", kind: "need" },
        { id: "cursor", label: "Cursor", col: "W", kind: "luxury" },
        { id: "claude", label: "Claude", col: "X", kind: "luxury" },
      ],
    },
  },
];
